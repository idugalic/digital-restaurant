...
class CreateCustomerCommand(@TargetAggregateIdentifier val targetAggregateIdentifier: String, @field:NotNull @field:Valid val name: PersonName, val orderLimit: Money, auditEntry: AuditEntry) : AuditableAbstractCommand(auditEntry) {
...
class CreateCustomerOrderCommand(@TargetAggregateIdentifier val targetAggregateIdentifier: String, @field:NotNull @field:Valid val orderTotal: Money, val customerId: String, auditEntry: AuditEntry) : AuditableAbstractCommand(auditEntry) {
