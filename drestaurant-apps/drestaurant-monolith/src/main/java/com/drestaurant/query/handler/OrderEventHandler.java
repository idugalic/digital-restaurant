...
class OrderEventHandler {
	...
	@Autowired
	public OrderEventHandler(OrderRepository orderRepository, CustomerRepository customerRepository, RestaurantRepository restaurantRepository, CourierRepository courierRepository) {
	...
	@EventHandler
	public void handle(OrderCreationInitiatedEvent event, @SequenceNumber Long aggregateVersion) {
	...
	@EventHandler
	public void handle(OrderVerifiedByCustomerEvent event, @SequenceNumber Long aggregateVersion) {
	...
	@EventHandler
	public void handle(OrderVerifiedByRestaurantEvent event, @SequenceNumber Long aggregateVersion) {
		OrderEntity orderEntity = orderRepository.findById(event.getAggregateIdentifier()).get();
	...
	@EventHandler
	public void handle(OrderPreparedEvent event, @SequenceNumber Long aggregateVersion) {
		OrderEntity orderEntity = orderRepository.findById(event.getAggregateIdentifier()).get();
		orderEntity.setAggregateVersion(aggregateVersion);
	...
	@EventHandler
	public void handle(OrderReadyForDeliveryEvent event, @SequenceNumber Long aggregateVersion) {
		OrderEntity orderEntity = orderRepository.findById(event.getAggregateIdentifier()).get();
		orderEntity.setAggregateVersion(aggregateVersion);
	...
	@EventHandler
	public void handle(OrderDeliveredEvent event, @SequenceNumber Long aggregateVersion) {
		OrderEntity orderEntity = orderRepository.findById(event.getAggregateIdentifier()).get();
		orderEntity.setAggregateVersion(aggregateVersion);
	...
	@EventHandler
	public void handle(OrderRejectedEvent event, @SequenceNumber Long aggregateVersion) {
		OrderEntity orderEntity = orderRepository.findById(event.getAggregateIdentifier()).get();
		orderEntity.setAggregateVersion(aggregateVersion);
